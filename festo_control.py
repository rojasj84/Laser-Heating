...
class FestoControlWindow(tk.Frame):
    def __init__(self, container, left_denkovi_com_port, right_denkovi_com_port):
        ...
        LeftSideControls = LeftSideFrame(self, left_denkovi_com_port)
        LeftSideControls.place(x = 2, y = 2)

        RightSideControls = RightSideFrame(self, right_denkovi_com_port)
        RightSideControls.place(x = 140, y = 2)
...
class RightSideFrame(tk.Frame):
    def __init__(self, parent, right_side_comport):
        ...
        R1_RNOTCH = tk.Checkbutton(self, text = "R1 Laser Notch", anchor='w', command= lambda:DenkTalk.flip_single_relay_status(right_side_comport,1))
        R1_RNOTCH.place(x=10,y=(button_height+5)*1,width=button_width,height=button_height)

        R2_R4COLM = tk.Checkbutton(self, text = "R2 4 Col Mirr", anchor='w', command= lambda:DenkTalk.flip_single_relay_status(right_side_comport,2))
        R2_R4COLM.place(x=10,y=(button_height+5)*2,width=button_width,height=button_height)

        R3_R4COLBS = tk.Checkbutton(self, text = "R3 4 Col BS", anchor='w', command= lambda:DenkTalk.flip_single_relay_status(right_side_comport,3))
        R3_R4COLBS.place(x=10,y=(button_height+5)*3,width=button_width,height=button_height)

        R4_RIRIS = tk.Checkbutton(self, text = "R4 Iris", anchor='w', command= lambda:DenkTalk.flip_single_relay_status(right_side_comport,4))
        R4_RIRIS.place(x=10,y=(button_height+5)*4,width=button_width,height=button_height)

        R5_RNDF70T = tk.Checkbutton(self, text = "R5 NDF T70", anchor='w', command= lambda:DenkTalk.flip_single_relay_status(right_side_comport,5))
        R5_RNDF70T.place(x=10,y=(button_height+5)*5,width=button_width,height=button_height)

        R6_RNDF50T = tk.Checkbutton(self, text = "R6 NDF 50T", anchor='w', command= lambda:DenkTalk.flip_single_relay_status(right_side_comport,6))
        R6_RNDF50T.place(x=10,y=(button_height+5)*6,width=button_width,height=button_height)

        R7_RNDF10T = tk.Checkbutton(self, text = "R7 NDF 10T", anchor='w', command= lambda:DenkTalk.flip_single_relay_status(right_side_comport,7))
 ...
 #       R89_RTO1MLENS.place(x=10,y=(button_height+7)*8,width=button_width,height=button_height)
        ...
        R89_RTO1MLENS = tk.Checkbutton(self, text = "R8-9 1m Lens", anchor='w', command= lambda:(DenkTalk.flip_single_relay_status(right_side_comport,8), DenkTalk.flip_single_relay_status(right_side_comport,9)))
        R89_RTO1MLENS.place(x=10,y=(button_height+7)*7.5,width=button_width,height=button_height)

        R10_RINGAAS = tk.Checkbutton(self, text = "R10 InGaAs M", anchor='w', command= lambda:DenkTalk.flip_single_relay_status(right_side_comport,10))
        R10_RINGAAS.place(x=10,y=(button_height+5)*9,width=button_width,height=button_height)

        R11_NIRF = tk.Checkbutton(self, text = "R11 NIR F", anchor='w', command= lambda:DenkTalk.flip_single_relay_status(right_side_comport,11))
        R11_NIRF.place(x=10,y=(button_height+5)*10,width=button_width,height=button_height)

        R12_RRUBYM = tk.Checkbutton(self, text = "R12 RUBY M", anchor='w', command= lambda:DenkTalk.flip_single_relay_status(right_side_comport,12))
...
class LeftSideFrame(tk.Frame):
    def __init__(self, parent, left_side_comport):
        ...
        L1_LNOTCH = tk.Checkbutton(self, anchor='w', text = "L1 Laser Notch", command= lambda:DenkTalk.flip_single_relay_status(left_side_comport,12))
        L1_LNOTCH.place(x=10,y=(button_height+5)*1,width=button_width,height=button_height)

        L2_L4COLM = tk.Checkbutton(self, text = "L2 4 Col Mirr", anchor='w', command= lambda:DenkTalk.flip_single_relay_status(left_side_comport,11))
        L2_L4COLM.place(x=10,y=(button_height+5)*2,width=button_width,height=button_height)

        L3_L4COLBS = tk.Checkbutton(self, text = "L3 4 Col BS", anchor='w', command= lambda:DenkTalk.flip_single_relay_status(left_side_comport,10))
        L3_L4COLBS.place(x=10,y=(button_height+5)*3,width=button_width,height=button_height)

        L4_LIRIS = tk.Checkbutton(self, text = "L4 IRIS", anchor='w', command= lambda:DenkTalk.flip_single_relay_status(left_side_comport,9))
        L4_LIRIS.place(x=10,y=(button_height+5)*4,width=button_width,height=button_height)

        L5_LNDF70T = tk.Checkbutton(self, text = "L5 NDF T70", anchor='w', command= lambda:DenkTalk.flip_single_relay_status(left_side_comport,8))
        L5_LNDF70T.place(x=10,y=(button_height+5)*5,width=button_width,height=button_height)

        L6_LNDF50T = tk.Checkbutton(self, text = "L6 NDF 50T", anchor='w', command= lambda:DenkTalk.flip_single_relay_status(left_side_comport,7))
        L6_LNDF50T.place(x=10,y=(button_height+5)*6,width=button_width,height=button_height)

        L7_LNDF10T = tk.Checkbutton(self, text = "L7 NDF10T", anchor='w', command= lambda:DenkTalk.flip_single_relay_status(left_side_comport,6))
        L7_LNDF10T.place(x=10,y=(button_height+5)*7,width=button_width,height=button_height)

        L89_LTO1MLENS = tk.Checkbutton(self, text = "L8-9 1m Lens", anchor='w', command= lambda:(DenkTalk.flip_single_relay_status(left_side_comport,5), DenkTalk.flip_single_relay_status(left_side_comport,4)))
        L89_LTO1MLENS.place(x=10,y=(button_height+7)*7.5,width=button_width,height=button_height)

        L10_RINGAAS = tk.Checkbutton(self, text = "L10 InGaAs M", anchor='w', command= lambda:DenkTalk.flip_single_relay_status(left_side_comport,3))
        L10_RINGAAS.place(x=10,y=(button_height+5)*9,width=button_width,height=button_height)

        L11_NIRF = tk.Checkbutton(self, text = "L11 NIR F", anchor='w', command= lambda:DenkTalk.flip_single_relay_status(left_side_comport,2))
